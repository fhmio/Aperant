...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-subprocess-e2b)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [子进程子系统](../../../docs/subsystems/subprocess.md)——子进程 seam 约定与生成的 Cordis 表面。
...
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-subprocess-e2b)——每个受支持配置字段及其源声明。
