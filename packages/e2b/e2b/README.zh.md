...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-e2b)完整列出了每个受支持字段及其 JSDoc，是这些信息的真源。
...
- [子进程子系统](../../../docs/subsystems/subprocess.md)——子进程 seam 约定与生成的 Cordis 表面，包括 `ctx.e2b`。
...
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-e2b)——每个受支持配置字段及其源声明。
