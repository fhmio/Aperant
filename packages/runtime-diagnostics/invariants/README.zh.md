...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-invariants)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [运行时不变量子系统](../../../docs/subsystems/invariants.md)——`Config`、installer、服务与配套入口约定的生成参考。
- [生成的配置目录](../../../docs/config-catalog.md#deepseek-aidsh-invariants)——每个受支持配置字段及其源声明。
