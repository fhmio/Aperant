...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-mcp-client)是每个受支持字段的穷尽式真源。
...
- [工具子系统参考](../../../docs/subsystems/tools.md)——接收已桥接工具的 `ToolRuntime` 与 `ctx.tools.register()` 约定。
...
- [第三方记忆 MCP 指南](../../../docs/user/guide/mcp-memory.md)——使用本包的三份记忆服务器 overlay。
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-mcp-client)——每个受支持配置字段及其源声明。
