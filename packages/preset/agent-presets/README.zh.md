...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-agent-presets)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [Scope 子系统](../../../docs/subsystems/scope.md)——scope key 与 agent 加入所经由的父链。
- [系统提示词子系统](../../../docs/subsystems/system-prompt.md)——preset 提示词段落如何注册与组装。
- [会话包映射](../../session/README.zh.md)——preset 切换所追加的持久会话记录。
- [生成的配置目录](../../../docs/config-catalog.md#deepseek-aidsh-agent-presets)——每个受支持配置字段及其源声明。
