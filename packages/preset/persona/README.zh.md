...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-persona)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [系统提示词子系统](../../../docs/subsystems/system-prompt.md)——段落、组装，以及本行所遮蔽的人设槽位。
- [生成的配置目录](../../../docs/config-catalog.md#deepseek-aidsh-persona)——每个受支持配置字段及其源声明。
