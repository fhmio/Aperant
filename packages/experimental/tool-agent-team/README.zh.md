...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-experimental-tool-agent-team)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [Agent Teams 子系统](../../../docs/subsystems/agent-team.md)——持久 Team 类型与服务 API。
- [生成的工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-experimental-tool-agent-team)——模型接收的每个工具 schema。
