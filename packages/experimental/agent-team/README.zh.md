...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-experimental-agent-team)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [Agent Teams 子系统](../../../docs/subsystems/agent-team.md)——持久 Team 类型与 `ctx.agentTeams` 服务 API。
