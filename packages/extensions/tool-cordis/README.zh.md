...
- [生成的工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-tool-cordis)——模型收到的确切 schema。
- [extensions 子系统](../../../docs/subsystems/extensions.md)——生成的 `ctx.cordisInspect` 与 `ctx.dynamicCordisRunner` API。
