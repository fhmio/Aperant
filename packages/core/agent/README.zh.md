...
- [Core 子系统](../../../docs/subsystems/core.md)——循环图、`Agent` 句柄、拦截决策与生成的服务 API。
- [agent-loop 包](../agent-loop/README.zh.md)——创建、驱动并拆除 agent 的默认驱动器。
- [会话子系统](../../../docs/subsystems/session.md)——句柄背后的持久日志与派生历史。
