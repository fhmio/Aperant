...
- [会话子系统](../../../docs/subsystems/session.md)——完整事件词汇、surface 类型与生成的服务 API。
- [持久化子系统](../../../docs/subsystems/persistence.md)——后端如何让该日志持久化。
- [Core 子系统](../../../docs/subsystems/core.md)——写入并派生会话的循环。
- [生成持久化目录](../../../docs/persistence-catalog.md)——每个会话事件及其载荷与声明位置。
