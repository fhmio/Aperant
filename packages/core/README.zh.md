...
- [Core 子系统](../../docs/subsystems/core.md)——逐包循环图与 `Agent` 句柄约定。
- [会话子系统](../../docs/subsystems/session.md)——会话事件词汇与派生历史。
- [系统提示词子系统](../../docs/subsystems/system-prompt.md)——提示词段、动态上下文与工具 schema 类型。
- [工具子系统](../../docs/subsystems/tools.md)——工具执行流水线与呈现词汇。
- [作用域注册子系统](../../docs/subsystems/scope.md)——这些注册表所依赖的作用域层原语。
- [架构](../../docs/architecture.md)——轮次流与新行为归属。
