...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-time-context)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [Schedule 用户指南](../../../docs/user/guide/schedule.md)——挂载本插件的官方配置路径。
- [context 组地图](../README.zh.md)——相邻的请求上下文包。
- [生成的配置目录](../../../docs/config-catalog.md#deepseek-aidsh-time-context)——每个受支持配置字段及其源声明。
