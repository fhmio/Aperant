...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tmux-context)是所有受支持字段及其 JSDoc 的完整真源。
...
- [shell 子系统](../../../docs/subsystems/shell.md)——只读查询所经由的执行器服务。
- [上下文组地图](../README.zh.md)——相邻的请求上下文包。
- [生成的配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tmux-context)——每个受支持配置字段及其源声明。
