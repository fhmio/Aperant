...
- [命令子系统](../../docs/subsystems/commands.md)——命令注册表语义与 `ctx.commands` 的 Cordis 接口面。
- [审批子系统](../../docs/subsystems/approval.md)——请求／结果词汇、应答者瀑布与按会话策略。
- [权限预设子系统](../../docs/subsystems/permission-presets.md)——预设表与旋钮写穿。
- [用户交互子系统](../../docs/subsystems/user-questions.md)——问题词汇、answerer waterfall 与呈现意图。
