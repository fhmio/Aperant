...
- [用户交互子系统参考](../../../docs/subsystems/user-questions.md)——此工具背后的服务约定、问题词汇与 answerer waterfall。
- [工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-tool-ask-user)——生成的 `ask_user_question` schema。
...
模型会看到生成的 [`ask_user_question` schema](../../../docs/tool-catalog.md#deepseek-aidsh-tool-ask-user)，其中包含问题 id、提示语、标题、选项与多选标志。
