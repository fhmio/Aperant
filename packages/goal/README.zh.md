...
- [目标子系统](../../docs/subsystems/goal.md)——目标类型、持久的 `goal/change` 事件与生成的服务 API。
- [生成的工具目录](../../docs/tool-catalog.md#deepseek-aidsh-tool-goal)——模型接收的三个目标工具 schema。
- [生成的配置目录](../../docs/config-catalog.md#deepseek-aidsh-goal)——目标服务的每个受支持配置字段。
