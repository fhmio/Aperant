...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-client-hmr)是所有受支持字段及其 JSDoc 的完整真源。
...
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-client-hmr)——每个受支持配置字段及其源声明。
