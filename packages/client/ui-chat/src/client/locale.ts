...
export const ar = {
  ...
  'duration.milliseconds': '{milliseconds} ملي ثانية',
  'stats.counts': '{turns} جولات {steps} خطوات',
  'stats.cacheHit': 'نسبة إصابة الذاكرة المخبئية {percent}%',
  'stats.dialog.title': 'إحصائيات الجلسة',
  'stats.dialog.usageTitle': 'استهلاك الرموز (Tokens)',
  'stats.dialog.llmTime': 'وقت النموذج',
  'stats.dialog.toolTime': 'وقت الأدوات',
  'stats.dialog.ttft': 'متوسط وقت أول رمز (TTFT)',
  ...
  'chat.toBottom': 'الانتقال للأسفل',
  'chat.deepDiving': 'جارٍ البحث والتحليل العميق...',
  'chat.turnNavigation.label': 'التنقل بين الجولات',
  ...
  'settings.transcript.description': 'التحكم في تفاصيل مراحل العمل في الجولات المكتملة',
  'settings.transcript.normal': 'افتراضي',
  'settings.transcript.compact': 'موجز',
  'fileOpen.title': 'تعذر فتح الملف',
  'fileOpen.unknown': 'تعذر فتح هذا الملف',
  'message.extraBlock': 'كتلة محتوى إضافية',
  'message.systemPrompt': 'موجه النظام',
  'message.systemPromptUpdate': 'تحديث موجه النظام',
  'message.contextInjection': 'حقن السياق',
  'message.contextRecall': 'استدعاء من الجلسة',
  ...
  'message.maxTokens': 'تم بلوغ الحد الأقصى لرموز المخرجات',
  'message.maxTokens.hint': 'تم قطع الرد؛ يتم الاحتفاظ بالمخرجات السابقة في المحادثة. أرسل "تابع" للسماح للنموذج بالاستمرار.',
  ...
  'message.turnUsage.model': 'المزود / النموذج',
  'message.turnUsage.cacheHit': 'إصابة الذاكرة المخبئية',
  'message.turnUsage.input': 'مدخلات غير مخبأة',
  'message.turnUsage.cacheRead': 'قراءة من الذاكرة المخبئية',
  'message.turnUsage.cacheWrite': 'كتابة في الذاكرة المخبئية',
  'message.turnUsage.output': 'المخرجات',
  'message.turnUsage.reasoning': ' ({tokens} رموز تفكير)',
  'message.turnUsage.count': '{count} رمز',
  'message.turnTime.title': 'وقت الجولة وسرعتها',
  'message.turnTime.duration': 'إجمالي وقت التشغيل',
  'message.turnTime.speed': 'الرموز في الثانية (TPS)',
  'message.turnTime.ttft': 'الوقت لأول رمز (TTFT)',
  ...
  'row.failed': 'فشل',
  'json.truncated': '… مقتطع، إجمالي {total} حرف',
  'clock.md': '{d}/{m}',
  'clock.ymd': '{y}-{m}-{d}',
