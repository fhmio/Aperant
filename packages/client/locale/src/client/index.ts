...
import { ar, en, type CommonKey } from '../locales/index.ts'
import {
  ar as settingsAr, en as settingsEn, type SettingsLocaleKey,
...
function syncDocumentLanguage(snapshot: LocaleSnapshot): void {
  ...
  document.documentElement.dir = snapshot.active === 'ar' ? 'rtl' : 'ltr'
}
...
export function apply(ctx: ClientContext): void {
  ...
  locale.register(COMMON_NS, { en, ar })
  locale.register(SETTINGS_NS, { en: settingsEn, ar: settingsAr })
