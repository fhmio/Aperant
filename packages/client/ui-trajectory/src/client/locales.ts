...
export const ar: Record<TrajectoryKey, string> = {
  'view.trajectory': 'سجل المسار',
  ...
  'kind.sub': 'فرعي',
  'column.input': 'المدخلات',
  'column.output': 'المخرجات',
  ...
  'timing.notRecorded': 'غير مسجل',
  'timing.stepStartUnavailable': 'وقت بدء الخطوة غير متاح',
  'timing.firstTokenUnavailable': 'وقت أول رمز غير متاح',
  'timing.usageUnavailable': 'بيانات الاستهلاك غير متاحة',
  'timing.outputTokensUnavailable': 'رموز المخرجات غير متاحة',
  'timing.durationTooShort': 'المدة قصيرة جداً',
  'timing.showLocalTime': 'عرض التوقيت المحلي',
  'timing.showUnixTimestamp': 'عرض طابع Unix الزمني',
  'timing.started': 'بدأ في',
  ...
  'usage.tokens': 'الرموز',
  'usage.reasoning': 'التفكير',
  'usage.content': 'المحتوى',
  'usage.notReported': 'الاستهلاك غير مسجل',
  'usage.input': 'المدخلات',
  'usage.cached': 'المخبأة',
  'usage.cacheCreated': 'المخبأة المنشأة',
  'usage.other': 'أخرى',
  'usage.output': 'المخرجات',
  'usage.thisRequest': 'هذا الطلب',
  'usage.sessionCumulative': 'تراكمي الجلسة',
  'options.notRecorded': 'الخيارات غير مسجلة',
  ...
  'source.notRecorded': 'المصدر غير مسجل',
  'source.messageJson': 'JSON مصدر الرسالة',
  'tab.summary': 'الملخص',
  'tab.rawOutput': 'المخرجات الخام',
  'tab.preview': 'معاينة',
  'tab.raw': 'خام',
  'tab.source': 'المصدر',
  'tab.payload': 'الحمولة',
  ...
  'tab.timing': 'التوقيت',
  'tab.diff': 'الفروقات',
  'tab.systemPrompt': 'موجه النظام',
  'tab.tools': 'الأدوات',
  'tab.options': 'الخيارات',
  'tab.usage': 'الاستهلاك',
  'record.toolCallOnly': '(استدعاء أداة فقط)',
  'record.noContent': 'لا يوجد محتوى',
  'record.noPayload': 'لم يتم تسجيل حمولة',
  'record.noResult': 'لم يتم تسجيل نتيجة',
  'record.noOutput': 'لا توجد مخرجات',
  'record.schemaUnavailable': 'المخطط غير متاح',
  'record.parameters': 'المعلمات',
  'record.resultJson': 'JSON النتيجة',
  'record.json': 'JSON',
  'record.parametersJson': 'JSON المعلمات',
  'record.namedParametersJson': 'JSON معلمات {name}',
  'record.payloadJson': 'JSON الحمولة',
  'record.outputJson': 'JSON المخرجات',
  'record.thinking': 'التفكير',
  'record.systemPromptMissing': 'لا يوجد موجه نظام في هذا الطلب',
  'record.toolsMissing': 'لا توجد أدوات في هذا الطلب',
  'record.systemPrompt': 'موجه النظام',
  'record.tools': 'الأدوات',
  'block.openSummary': 'فتح ملخص استدعاء أداة الكتلة #{index}',
  ...
  'request.retryProgress': '{retry} من أصل {maximum}',
  'request.collapsedSummary': 'ملخص مطوي لـ {kind}، {summary}',
  ...
  'summary.toolCalls.one': 'استدعاء أداة واحد',
  'summary.toolCalls.other': '{count} استدعاءات أدوات',
  'summary.steps.one': 'خطوة واحدة',
  'summary.steps.other': '{count} خطوات',
  'details.event': 'تفاصيل الحدث',
  'details.resize': 'إعادة تحجيم تفاصيل الحدث',
  'details.resizeTitle': 'اسحب لإعادة التحجيم. انقر نقراً مزدوجاً لإعادة التعيين.',
  ...
  'layout.initialSystemPrompt': 'موجه النظام الأولي',
  'layout.systemPromptUpdated': 'تم تحديث موجه النظام',
  'layout.toolsUpdated': 'تم تحديث الأدوات',
  'layout.systemPromptAndToolsUpdated': 'تم تحديث موجه النظام والأدوات',
  'layout.compactionInterrupted': 'تمت مقاطعة الضغط قبل اكتماله.',
}
