...
/**
 * The hero brand mark (34px wide). Decorative — hidden from the accessibility tree.
 * Hovering triggers the gentle sway animation defined in CSS on the hitbox.
 * @param _props - driven by the hitbox parent's pointer state.
 * @returns the logo element.
 */
function HeroFish(_props: { hovering: boolean }) {
  return (
