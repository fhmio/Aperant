...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tool-jobs)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [生成的工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-tool-jobs)——`job_output`、`job_list` 与 `job_kill` 的确切 schema。
- [生成的配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tool-jobs)——每个受支持配置字段及其源声明。
