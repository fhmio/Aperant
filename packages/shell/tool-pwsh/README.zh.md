...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tool-pwsh)是每个受支持字段及其 JSDoc 的穷尽式真源；生成的[工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-tool-pwsh)携带完整参数 schema。
...
- [生成的工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-tool-pwsh)——`pwsh` 参数 schema 的确切内容。
- [生成的配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tool-pwsh)——每个受支持配置字段及其源声明。
...
模型会看到生成的 [`pwsh` schema](../../../docs/tool-catalog.md#deepseek-aidsh-tool-pwsh)。按 agent 作用域实施的工具限制可以移除该 agent 的定义。
