...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-shell-env)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [Bash 执行器子系统](../../../docs/subsystems/shell.md)——工具执行所经由的 `ctx.shell` seam。
...
- [生成的配置目录](../../../docs/config-catalog.md#deepseek-aidsh-shell-env)——每个受支持配置字段及其源声明。
