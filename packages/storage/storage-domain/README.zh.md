...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-storage-domain)是所有受支持字段及其 JSDoc 的完整真源。
...
- [存储子系统](../../../docs/subsystems/storage.md)——领域约定、后端约定、变更事件与生成的 API。
...
- [Workspace 子系统](../../../docs/subsystems/workspace.md)——领域数据形式的第一个消费方。
