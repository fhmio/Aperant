...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-settings-file)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [设置子系统参考](../../../docs/subsystems/settings.md)——namespace、解析顺序、descriptor 与变更提交。
...
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-settings-file)——每个受支持配置字段及其源声明。
