...
- [凭据子系统参考](../../../docs/subsystems/credentials.md)——两个键空间与两个 seam 的生成 Cordis 接口面。
- [凭据包映射](../README.zh.md)——凭据引用、本地存储与授权三个包。
- [凭据引用 seam](../credentials/README.zh.md)——每个 flow 都经由它提交的记录存储。
- [能力 seam](../../../docs/capability-seams.md)——本 seam 遵循的 Service Definition / Service Provider / Consumer 拆分。
