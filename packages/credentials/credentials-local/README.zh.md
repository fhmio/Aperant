...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-credentials-local)完整列出了所有受支持字段及其 JSDoc，是这些信息的真源。
...
- [凭据子系统参考](../../../docs/subsystems/credentials.md)——`CredentialRef`、按操作解析、对 UI 安全的 `CredentialInfo`、提供方层。
