...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tool-skill)是每个受支持字段的穷尽式真源。
...
- [skill 子系统参考](../../../docs/subsystems/skills.md)——目录背后的注册表与提供方词汇。
- [skill 包](../skill/README.zh.md)——注册表与共享的 `renderSkillContent` 渲染。
- [生成工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-tool-skill)——模型接收的精确 `skill` schema。
