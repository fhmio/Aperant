...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-skill)是每个受支持字段的穷尽式真源。
...
- [skill 子系统参考](../../../docs/subsystems/skills.md)——注册表、提供方约定与本地发现优先级。
...
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-skill)——每个配置字段及其源声明。
