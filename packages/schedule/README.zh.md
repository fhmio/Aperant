...
- [仅限会话内的 Schedule 子系统](../../docs/subsystems/schedule.md)——持久记录、转换、视图与交付约定。
- [生成的工具目录](../../docs/tool-catalog.md#deepseek-aidsh-schedule)——模型接收的 `schedule_create`／`schedule_list`／`schedule_delete` schema。
- [Schedule 用户指南](../../docs/user/guide/schedule.md)——挂载本包的官方配置路径。
