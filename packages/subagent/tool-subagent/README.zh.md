...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tool-subagent)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [Subagent 子系统](../../../docs/subsystems/subagent.md)——提供方、一次性启动请求、可继续子 agent 与 Activation。
- [dsh-tool-subagent-control](../tool-subagent-control/README.zh.md)——可继续子 agent 的消息、中断与列表工具。
- [生成工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-tool-subagent)——默认 schema 与各模式的措辞。
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-tool-subagent)——每个受支持配置字段。
