...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-subagent-spawn-in-process)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [Subagent 子系统](../../../docs/subsystems/subagent.md)——启动请求、结果、实时运行与提供方约定。
...
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-subagent-spawn-in-process)——每个受支持配置字段及其源声明。
