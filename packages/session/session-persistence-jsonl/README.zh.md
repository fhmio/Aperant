...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-session-persistence-jsonl)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [会话持久化子系统](../../../docs/subsystems/persistence.md)——后端无关的服务语义与提供方关系。
