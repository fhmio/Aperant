...
- [生成工具目录](../../../docs/tool-catalog.md#deepseek-aidsh-tool-str-replace-editor)——本包注册的穷尽式 schema。
...
生成的 [`str_replace_editor` schema](../../../docs/tool-catalog.md#deepseek-aidsh-tool-str-replace-editor)，包含配置的 `description`。本插件不贡献独立系统提示词段。
