...
生成的[配置目录](../../../docs/config-catalog.md#deepseek-aidsh-web-fetch-http)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [web 子系统](../../../docs/subsystems/web.md)——穷尽式的抓取请求／结果词汇与错误码。
...
- [生成配置目录](../../../docs/config-catalog.md#deepseek-aidsh-web-fetch-http)——每个受支持配置字段及其源声明。
